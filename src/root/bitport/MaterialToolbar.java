...
public class MaterialToolbar extends Region {
    ...
    public MaterialToolbar() {
        ...
        currentTitle = new Label("BitPort");
    ...
    public void animateTo(Paint color, String title, IconType iconType, ToolbarAction... actions) {
        changeViewAnimationCircle.setOpacity(0);
        ...
        circleTransition.setOnFinished(e -> {
            ...
            if(actions!=null)
	            for(ToolbarAction action : actions) {
	                ...
	                actionButton.setGraphic(action.getGraphic());
    ...
    public AnimatedIcon getMainIcon()
    {
